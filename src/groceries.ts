...
function createGroceries(): string[] {
 ...
 ["eggs","milk","water","flour","bread","tea"]
  return ["eggs","milk","water","flour","bread","tea"]; // replace empty array with what you see is fit
}
// Step 2:
...
function getFirstThreeGroceryItems(groceries: string[]): string[] {
  // write your code here...
  return groceries.slice(0, 3); // returns a new array with the first three items
}
